# Lista de Conteúdos - EduSexual PT (Backlog)

> Este ficheiro serve como "memória" de todos os conteúdos a criar para o site.
> Marca com [x] quando estiver implementado no content.ts

---

## CRIANÇAS (6-12 anos)

### Tema: Conhecer o meu Corpo
- [x] O meu corpo é único
...
- [x] Clamídia: a IST mais comum em jovens
- [x] HPV e a vacina: o que precisas de saber
- [x] VIH/SIDA: realidades e mitos
- [x] Herpes genital
- [x] Sífilis e gonorreia
- [x] Como prevenir IST
- [x] Quando fazer testes: rastreio de IST
- [x] IST podem não ter sintomas!

### Tema: Relações e Afetos
- [x] O que é uma relação saudável?
...
### Tema: Consentimento e Limites
- [x] O que é consentimento? Regra do "Sim" entusiástico
- [x] Consentimento pode ser retirado a qualquer momento
- [x] Pressão dos outros: como resistir
- [x] Quando álcool e consentimento se cruzam
- [x] Lei do consentimento em Portugal

### Tema: Orientação Sexual e Identidade de Género
- [x] Orientação sexual: o que é?
- [x] Heterossexualidade, homossexualidade, bissexualidade
- [x] O espetro da sexualidade: não é só preto e branco
- [x] Identidade de género vs. orientação sexual
- [x] Pessoas trans: o que precisas de saber
- [x] Ser não-binário
- [x] Coming out: como apoiar quem assume
- [x] Recursos LGBTQI+ em Portugal
...
## ADULTOS / PAIS / EDUCADORES

### Tema: Guia para Pais e Educadores
