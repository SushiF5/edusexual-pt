...
export const frequentlyAskedQuestions: FAQEntry[] = [
  ...
  },
  {
    ...
    answer: "Não. Estudos internacionais (OMS, UNESCO) demonstram que a educação sexual de qualidade NÃO adianta o início da atividade sexual. Pelo contrário: jovens informados tendem a iniciar mais tarde, com mais proteção e melhores decisões."
  },
  {
    id: "faq-genitais",
