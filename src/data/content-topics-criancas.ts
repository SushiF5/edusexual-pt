...
export const topicsCriancas: Topic[] = [
  // --- SECÇÃO CRIANÇAS ---
  {
    id: "corpo-criancas",
...
Um segredo mau: "Isto fica entre nós, não contes a ninguém, senão..." — se alguém te disser isto, **não é segredo, é perigo**. Conta logo aos teus pais ou a um professor.`
      },
      {id: "pedir-ajuda",
...
1. Diz "NÃO!" bem alto.
2. Afasta-te dessa pessoa.
3. Conta **logo** a um adulto em quem confies: pai, mãe, professor, avós.
4. Se não tiveres ninguém por perto, liga 116 111 (Linha Criança) — é grátis e não aparece na fatura.

Não é "queixa", é protegeres-te. Tu importas!`
      },
      {id: "online-seguranca",
...
- Se alguém online te pedir fotos tuas ou te fizer perguntas esquisitas: **não respondas, bloqueia, conta aos pais**.
- Combina com os pais um "código de segurança" para saberes se uma mensagem é mesmo deles.`
      },
    ]
  },
  {
...
- Respeita quando dizes "Não" ou "Não quero jogar isso".
- Fica feliz quando te corre bem, não tem inveja.
- Pede desculpa se erra e perdoa se tu erras.

Tu também podes ser esse amigo!`
      },
...
- Lembra-te: isto passa. Amanhã é outro dia.

Se a tristeza durar muitos dias ou não conseguires fazer as tuas coisas normais, diz aos pais — eles podem ajudar-te a falar com um psicólogo (um "médico dos sentimentos").`
      },
    ]
  },
  {
