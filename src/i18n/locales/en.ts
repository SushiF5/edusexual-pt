...
export const en: TranslationKeys = {
  ...
  tabLearn: "Learn",
  tabLearnDesc: "A-Z glossary, practical guides, and FAQs",
  tabToolsDesc: "Comparator, myths, quiz, consent, and STI testing",
  tabPodcastDesc: "Audio episodes and complete transcripts",
  tabRightsDesc: "24/7 helplines, healthcare rights, and questions",
  settings: "Settings",
